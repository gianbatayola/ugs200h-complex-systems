...
to transact
  ...
  set wealth wealth  + you * exchange_rate - me * cost-of-giving
  ask one-of other turtles [set wealth wealth + me * exchange_rate - me * cost-of-giving]
end
...
to recolor-turtles
  ...
  set percentile75 [wealth] of item (0.75 * length(mylist)) mylist
  set percentile50 [wealth] of item (0.50 * length(mylist)) mylist
  set percentile25 [wealth] of item (0.25 * length(mylist)) mylist
  ask turtles
